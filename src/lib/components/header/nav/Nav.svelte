<script>
    ...
    $: menus.set([
        { id: 0, name: 'Home', link: '/'},
        { id: 1, name: 'Categories', link: '', subMenu: true, menuList: [
...
<nav class="relative flex flex-wrap items-center justify-between py-[0.5rem] px-[1rem] mobile:!p-0">
    <!--navbar-collapse-->
    <div class="!flex basis-auto grow items-center dark:border-[#99999926] mobile:basis-full mobile:bg-white mobile:dark:bg-[#101213] mobile:px-[15px] mobile:pt-[30px] mobile:pb-0 mobile:border-b mobile:border-solid mobile:border-[#E6E7E7] hidden">
                    ...
                    >
                        {#if $showMenu && (selectedMenu == menu)}
                            <ul 
                                ...
                                class="bg-white dark:bg-[#101213] rounded-none p-5 absolute text-[#212529] text-left bg-clip-padding left-0 z-[1000] min-w-[10rem] mb-0 mx-0 text-base border border-solid border-[#E6E7E7] dark:border-[#99999926] float-none mobile:top-[100%] {$showMenu ? 'block visible opacity-100' : 'hidden invisible opacity-0'} mobile:hidden transition-all duration-[0.3s] delay-0 ease mobile:mt-[0.125rem] mt-2.5">
